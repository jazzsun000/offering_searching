...
Note: If you want to skip the preprocessing step a [df_processed_df.bz2](offering_searching/offering_search_API/df_processed_df.bz2) file has been provided. 
